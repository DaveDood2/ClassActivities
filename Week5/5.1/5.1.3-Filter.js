...
// let incompleteTasks = data.filter(function(element) {
//   return !element.completed;
// });
let incompleteTasks = data.filter(element => element.completed === false);
console.log(incompleteTasks, incompleteTasks[0]);

// filter for user 6's tasks
let user6Tasks = data.filter(element => {
  return element.userId === 6;
});
console.log(user6Tasks, user6Tasks[0]);

// filter for tasks with a title less than 24 characters long
let shortTitle = data.filter(element => {
  return element.title.length < 24;
});
console.log(shortTitle, shortTitle[0]);
